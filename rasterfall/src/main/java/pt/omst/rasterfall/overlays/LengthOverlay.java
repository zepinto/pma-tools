...
public class LengthOverlay extends AbstractOverlay {
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        if (firstPosition != null && lastPosition != null && firstPosition.location() != null && lastPosition.location() != null) {
            ...
            if (lastPoint != null)
                g2.drawString(String.format("%.1f m", firstPosition.location().getDistanceInMeters(lastPosition.location())), (int)lastPoint.getX()+10, (int)lastPoint.getY()-10);
            else
                g2.drawString(String.format("%.1f m", firstPosition.location().getDistanceInMeters(lastPosition.location())), (int)currentPoint.getX()+10, (int)currentPoint.getY()-10);
        }
     }
