...
public class SidescanParameters {
    ...
    private boolean rawNormalization = false;
    ...
    /**
     * @return the rawNormalization
     */
    public boolean isRawNormalization() {
        return rawNormalization;
    }

    /**
     * @param rawNormalization the rawNormalization to set
     */
    public void setRawNormalization(boolean rawNormalization) {
        this.rawNormalization = rawNormalization;
    }
