...
public class SystemPositionAndAttitude implements Cloneable, Comparable<SystemPositionAndAttitude>, Serializable {
    ...
    public double getSpeed() {
        return Math.sqrt(uvw.x*uvw.x + uvw.y * uvw.y + uvw.z * uvw.z);
    }
    ...
    /**
     * This function changes this state by rotating the vehicle according to the angle given This
     * rotation will be done only in the horizontal plane (x,y)
     *
    ...
    /**
     * This function changes the current state by moving the vehicle forward If the value of meters
     * is negative, the vehicle will actually move back
     *
    ...
    /**
     * This function changes the current state by moving the vehicle up If the value of meters is
     * negative, the vehicle will actually move down
     *
