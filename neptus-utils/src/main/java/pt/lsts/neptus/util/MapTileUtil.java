...
public class MapTileUtil {
     ...
     * @param levelOfDetail Level of detail, from 1 (lowest detail) to 23 (highest
     *                      detail).
     ...
     * detail.
     *
     * @param levelOfDetail Level of detail, from {@value #LEVEL_MIN} (lowest
     *                      detail) to {@value
     *                      #LEVEL_MAX} (highest detail).
     ...
     * @return tileX: Output parameter receiving the tile X coordinate. tileY:
     *         Output parameter
     *         receiving the tile Y coordinate.
     */
     ...
     * @return tileX: Output parameter receiving the tile X coordinate. tileY:
     *         Output parameter
     *         receiving the tile Y coordinate. levelOfDetail: Output parameter
     ...
     * @param tileX Tile X coordinate.
     * @param tileY Tile Y coordinate.
     * @return pixelX: Output parameter receiving the pixel X coordinate. pixelY:
     *         Output parameter
     *         receiving the pixel Y coordinate.
     */
    ...
    /**
     * This will return an north and east offsets using Mercator projection at
     * levelOfDetail={@value
     * #LEVEL_OFFSET}. Calls
    ...
    /**
     * This will return an north and east offsets using Mercator projection in an
     * specific
     * levelOfDetail.
     */
    public static double[] getOffsetFrom(double latitudeRef, double longitudeRef, double latitude, double longitude,
    ...
    /**
     * Distance in meters between two locations using 6371 as average earth radius
     * in meters
     * Harversine formula
     */
